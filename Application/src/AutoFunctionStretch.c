...
const WALK_KNEAD_KNOCK_MOTOR_STRUCT_AUTO AutoFunctionStretch[] = {
  ...
  {BACK_SUB_MODE_WAVELET,WALK_LOCATE_PARK,0,KNEAD_RUN,0,KNOCK_RUN,0,0,SPEED_3,_3D_PROGRAM,AXIS_MIDDLE,_3D_SPEED_3,0},        //充气，拉腿准备阶段
  {BACK_SUB_MODE_PRESS,WALK_LOCATE_ABSULATE,WAIST_POSITION,KNEAD_STOP_AT_MIN,0,KNOCK_STOP,8,2,SPEED_1,_3D_PROGRAM,AXIS_MIDDLE,_3D_SPEED_3,0}, //拉腿
  {BACK_SUB_MODE_KNEAD,WALK_LOCATE_PARK,0,KNEAD_RUN,0,KNOCK_STOP,0,0,SPEED_3,_3D_PROGRAM,AXIS_STRONGEST,_3D_SPEED_3,0},	//加压时间	
  
  {BACK_SUB_MODE_PRESS,WALK_LOCATE_ABSULATE,LIMIT_POSITION,KNEAD_STOP_AT_MIN,0,KNOCK_STOP,8,2,SPEED_1,_3D_PROGRAM,AXIS_STRONGER,_3D_SPEED_3,0}, //拉腿
  {BACK_SUB_MODE_KNEAD,WALK_LOCATE_PARK,0,KNEAD_RUN,0,KNOCK_STOP,0,0,SPEED_3,_3D_PROGRAM,AXIS_STRONGEST,_3D_SPEED_3,0}	//加压时间	
