...
static void WalkPower_On(void)
{
  // WalkMotor_Set_Pwm_Data(WALK_MOTOR_DEFAULT_TOP);
    ...
    {
        if(st_RestSleep.step == 0){WalkMotor_Set_Pwm_Data(130);}//120:22
        if(st_RestSleep.step == 1){WalkMotor_Set_Pwm_Data(80);}//100:18
        if(st_RestSleep.step == 2){WalkMotor_Set_Pwm_Data(50);}//60:10
    } 
    else if(KneadState==KNEAD_MED_MED 
    ...
    {
        WalkMotor_Set_Pwm_Data(WALK_MOTOR_DEFAULT_TOP);//30v
    }
