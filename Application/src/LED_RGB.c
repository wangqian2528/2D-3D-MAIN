...
bool bFlag10ms;
unsigned int w_LEDSteps;  //ÓÃì¶Ó›ä›®”Ç°µÄï@Ê¾²½óE
unsigned int w_LEDTimer;  //ÓÃì¶Ó›ä›®”Ç°²½ÖèµÄÔËÐÐÊ±¼ä µ¥Î»0.1Ãë
unsigned int w_LEDCtrlTimer;  //¿ØÖÆLEDµÄ½¥ÁÁ»ò½¥°µµÄ¶¨Ê±Æ÷
...
bool b_LED_Init;
  ...
  const st_LEDCtrlStruct LED_Settle[] = 
  {
    ...
    {80,0,0,LED_SLOWLY_LIGHT,LED_DARK,LED_DARK,2},     //ºìÉ«
    {100,0,0,LED_SLOWLY_DARK,LED_SLOWLY_LIGHT,LED_DARK,50}, //ºìÉ«½¥°µÂÌÉ«½¥ÁÁ
    {0,100,0,LED_DARK,LED_SLOWLY_DARK,LED_SLOWLY_LIGHT,50}, //ÂÌÉ«½¥°µÀ¶É«½¥ÁÁ
    {0,0,100,LED_SLOWLY_LIGHT,LED_DARK,LED_SLOWLY_DARK,50}, ////ºìÉ«½¥ÁÁÀ¶É«½¥°µ
  };
  ...
  {
    {0,0,0,LED_SLOWLY_LIGHT,LED_DARK,LED_DARK,50},  //ºìÉ«½¥ÁÁ
    {100,0,0,LED_SLOWLY_DARK,LED_DARK,LED_DARK,50},  //ºìÉ«½¥°µ
    
    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
    
    {0,0,0,LED_DARK,LED_SLOWLY_LIGHT,LED_DARK,50},  //ÂÌÉ«½¥ÁÁ
    {0,100,0,LED_DARK,LED_SLOWLY_DARK,LED_DARK,50},  //ÂÌÉ«½¥°µ
    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
    
    {0,0,0,LED_DARK,LED_DARK,LED_SLOWLY_LIGHT,50},  //ÂÌÉ«½¥ÁÁ
    {0,0,100,LED_DARK,LED_DARK,LED_SLOWLY_DARK,50},  //ÂÌÉ«½¥°µ
    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
    
    {0,0,0,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,50},     //°×É«½¥ÁÁ
    {100,100,100,LED_SLOWLY_DARK,LED_SLOWLY_DARK,LED_SLOWLY_DARK,50},  //°×É«½¥°µ
    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
    
    {100,0,0,LED_LIGHT,LED_DARK,LED_DARK,5},     //ºìÉ«
    {100,30,0,LED_LIGHT,LED_LIGHT,LED_DARK,5},   //³ÈÉ«
    {100,100,0,LED_LIGHT,LED_LIGHT,LED_DARK,5},  //»ÆÉ«
    {0,100,0,LED_DARK,LED_LIGHT,LED_DARK,5},     //ÂÌÉ«
    {0,0,100,LED_DARK,LED_DARK,LED_LIGHT,5},     //À¶É«
    {100,0,100,LED_LIGHT,LED_DARK,LED_LIGHT,5},  //×ÏÉ«
    
    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},
    
    {50,0,0,LED_SLOWLY_LIGHT,LED_DARK,LED_DARK,10},     //ºìÉ«
    {100,0,0,LED_SLOWLY_DARK,LED_SLOWLY_LIGHT,LED_DARK,50}, //ºìÉ«½¥°µÂÌÉ«½¥ÁÁ
    {0,100,0,LED_DARK,LED_SLOWLY_DARK,LED_SLOWLY_LIGHT,50}, //ÂÌÉ«½¥°µÀ¶É«½¥ÁÁ
    {0,0,100,LED_SLOWLY_LIGHT,LED_DARK,LED_SLOWLY_DARK,50}, ////ºìÉ«½¥ÁÁÀ¶É«½¥°µ
...
//    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
////    
//    {0,0,0,LED_SLOWLY_LIGHT,LED_DARK,LED_DARK,50},  //ÂÌÉ«½¥ÁÁ
//    {0,0,100,LED_DARK,LED_SLOWLY_DARK,LED_DARK,50},  //ÂÌÉ«½¥°µ
//    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
//    
//    {0,0,0,LED_DARK,LED_DARK,LED_SLOWLY_LIGHT,50},  //ÂÌÉ«½¥ÁÁ
//    {0,0,100,LED_DARK,LED_DARK,LED_SLOWLY_DARK,50},  //ÂÌÉ«½¥°µ
//    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
    ...
    {0,0,0,LED_SLOWLY_LIGHT,LED_DARK,LED_DARK,50},     //½¥ÁÁ
    //{10,30,100,LED_SLOWLY_DARK,LED_SLOWLY_LIGHT,LED_SLOWLY_DARK,50},       //½¥°µ
    
//    {50,30,50,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,50},     //½¥ÁÁ
//    {50,30,50,LED_SLOWLY_DARK,LED_SLOWLY_DARK,LED_SLOWLY_DARK,50},       //½¥°µ
//    
//    {10,50,10,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,50},     //½¥ÁÁ
//    {10,50,10,LED_SLOWLY_DARK,LED_SLOWLY_DARK,LED_SLOWLY_DARK,50},       //½¥°µ
//    
//    {0,0,0,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,LED_SLOWLY_LIGHT,50},     //°×É«½¥ÁÁ
//    {100,100,100,LED_SLOWLY_DARK,LED_SLOWLY_DARK,LED_SLOWLY_DARK,50},  //°×É«½¥°µ
//    {0,0,0,LED_DARK,LED_DARK,LED_DARK,10},  //¹Ø1Ãë
    
    {100,0,0,LED_LIGHT,LED_DARK,LED_DARK,5},     
    {100,30,0,LED_LIGHT,LED_LIGHT,LED_DARK,5},   
    {100,100,0,LED_LIGHT,LED_LIGHT,LED_DARK,5},  
//    {0,100,0,LED_DARK,LED_LIGHT,LED_DARK,5},     //ÂÌÉ«
//    {0,0,100,LED_DARK,LED_DARK,LED_LIGHT,5},     //À¶É«
    {100,0,100,LED_LIGHT,LED_DARK,LED_LIGHT,5},  //×ÏÉ«
...
//  static bool bRoute = false;
  ...
  */
  ...
  {
    b_LED_Init = TRUE;  //°´Ä¦ÒÎ×´Ì¬ÇÐ»»Ê±£¬ÐèÒª³õÊ¼»¯°´Ä¦ÒÎ¿ØÖÆ³ÌÐò
  ...
  if(b_LED_Init)  //LEDÏÔÊ¾Êý¾Ý±»³õÊ¼»¯£¬ÏÔÊ¾´Ó±íÍ·¿ªÊ¼
  {
    w_LEDTimer = 0;
    w_LEDCtrlTimer = 0;
    w_LEDSteps = 0;
